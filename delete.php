 ...
 * @version $SixXGate: webapps/dacomasy/www/delete.php,v 1.1.1.1 2005/07/21 22:57:31 matthew Exp $
...
// Confirmed Delete //////////////////////////////////////////////////////////////////////////////////////
case 'confirmed':
	if (DacomasyDeleteRecord($module, $PanelIndex, $RecordIndex, $PlaceValue) === FALSE) {
	echo '<p>' . $__dacomasy__MSG_res[__DACOMASY_MSG_DELFAILED] . '</p>';
	} else {
	echo '<p>' . $__dacomasy__MSG_res[__DACOMASY_MSG_DELSUCCESS] . '</p>';
...
default: ?>
	...
	//--></script>
	<form action="delete.php?mod=<?php echo urlencode($ModuleFilename); ?>&amp;pan=<?php echo $PanelIndex; ?>&amp;index=<?php echo urlencode($RecordIndex); ?><?php if ($PlaceValue != NULL) echo '&amp;place=' . urlencode($PlaceValue); ?>&amp;<?php echo DacomasySID(); ?>" method="post">
		<p>Are you sure you want to delete this record?</p>
		<button name="action" value="confirmed"><img src="images/ok.<?php echo $ImageExt; ?>" alt=""><?php echo $__dacomasy__LABEL_res[__DACOMASY_LABEL_YES]; ?></button><button name="action" value="cancelled"><img src="images/cancel.<?php echo $ImageExt; ?>" alt=""><?php echo $__dacomasy__LABEL_res[__DACOMASY_LABEL_NO]; ?></button>
	</form>
<?php } ?>
</body>
